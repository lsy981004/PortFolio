...
<body>
	...
	<div class="headerimg">
		...
		<div class="header-title">
  			<p  style="font-family: 'OAGothic-ExtraBold'; ">- 이신영 -</p>
  			<p>웹 개발자 포트폴리오</p>
		</div>  
...
<div class="AboutMe1">
  <div style="display: flex; align-items: center;">
    ...
    <div class="AboutMe_name">이름<br><div class="AboutMe_myname">이신영</div></div>
...
<div class="AboutMe2">
  <div style="display: flex; align-items: center;">
    ...
    <div class="AboutMe_birth">생년월일<br><div class="AboutMe_mybirth">98.10.04</div></div>
...
<div class="AboutMe3">
  <div style="display: flex; align-items: center;">
    ...
    <div class="AboutMe_address">주소지<br><div class="AboutMe_myaddress">서울특별시 광진구</div></div>
  </div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
    ...
    <div class="AboutMe_pnumber">연락처<br><div class="AboutMe_mypnumber">010-8098-6209</div></div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
  <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/>
    ...
    <div class="AboutMe_email">이메일<br><div class="AboutMe_myemail">lsy981004@gmail.com</div></div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
  <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z"/>
    ...
    <div class="AboutMe_career">학력<br><div class="AboutMe_mycareer"> 컴퓨터공학과 </div></div>
...
<div class="archiving-container1">
  ...
  <div class="archiving1">
    ...
    <!-- 예를 들면 텍스트, 이미지, 기타 요소 등이 올 수 있습니다. -->
		...
		<p style="font-family: 'OAGothic-ExtraBold'; font-size: 20px; color: black;">소스 코드 저장소 입니다.</p>
	</div>
</div>
</div>
...
<div class="career-container2">
    ...
    <div class="career-item1">
        <h3 style="font-family: 'OAGothic-ExtraBold'; font-size: 22px; font-weight: bold; display: inline-block; vertical-align: middle;"> (주)타키온홀딩스 / 인턴</h3>
        <p style="font-family: 'OAGothic-ExtraBold'; font-size: 15px; color: gray;"> 2021.01 - 2021.02</p>
            <p style="font-family: 'OAGothic-ExtraBold';">- 학교 연계 동계 인턴쉽</p>
            <p style="font-family: 'OAGothic-ExtraBold';">-  ios/android 환경 QA 테스트 및 보고서 작성 <br></p>
            <!-- 필요한 만큼 항목 추가 -->
    ...
    <div class="career-item2">
        <h3 style="font-family: 'OAGothic-ExtraBold'; font-size: 22px; font-weight: bold; display: inline-block; vertical-align: middle;"> TEST / -</h3>
        <p style="font-family: 'OAGothic-ExtraBold'; font-size: 15px; color: gray;"> 2021.00 - 2022.00</p>
            <p style="font-family: 'OAGothic-ExtraBold';">- test </p>
            <p style="font-family: 'OAGothic-ExtraBold';">- test <br>test </p>
            <!-- 필요한 만큼 항목 추가 -->
